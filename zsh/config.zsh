...
export JEKYLL_HOME='/usr/local//Cellar/ruby/2.1.1/bin'
export GRADLE_HOME=/Users/aaron/Sandbox/gradle-2.2.1
export JAVA_HOME=/Library/Java/JavaVirtualMachines/jdk1.7.0_45.jdk/Contents/Home

export PATH=${PATH}:${JEKYLL_HOME}
export PATH=${PATH}:/usr/local//Cellar/ruby/2.1.0/bin:/usr/local/opt/postgresql92/bin
